# -*- coding: utf-8 -*-
"""Qwen3.8 video LoRA fine-tuning (bf16) example.
...
Run: ``uv run video_qwen38_bf16_baseline.py``

NOTE: bf16 variant. Identical to video_qwen35.py except that the base model
...
OUTPUT_DIR   = HERE / "outputs_video_bf16"
ADAPTER_DIR  = HERE / "qwen_video_lora_bf16"
