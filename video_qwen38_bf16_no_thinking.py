# -*- coding: utf-8 -*-
"""Qwen3.8 video LoRA fine-tuning (bf16) — response-only loss + thinking disabled.
...
Run: ``uv run video_qwen38_bf16_no_thinking.py``

NOTE: bf16 variant. Identical to video_qwen38_no_thinking.py except that the base model
...
OUTPUT_DIR   = HERE / "outputs_video_bf16_no_thinking"
ADAPTER_DIR  = HERE / "qwen_video_lora_bf16_no_thinking"
