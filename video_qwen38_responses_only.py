# -*- coding: utf-8 -*-
"""Qwen3.8 video QLoRA fine-tuning — response-only loss variant.
...
Run: ``uv run video_qwen38_responses_only.py``
"""
...
OUTPUT_DIR   = HERE / "outputs_video_responses_only"
ADAPTER_DIR  = HERE / "qwen_video_lora_responses_only"
